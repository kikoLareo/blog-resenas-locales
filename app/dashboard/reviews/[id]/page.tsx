...
function ReviewDetailClient({ review }: { review: ReviewWithDetails }) {
                ...
                <div className="space-y-4">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <div className="flex">{renderStars(review.ratings.overall)}</div>
                      <span className="font-bold">{review.ratings.overall.toFixed(1)}/5.0</span>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center justify-between">
                    <span>Ambiente</span>
                    <div className="flex items-center space-x-2">
                      <div className="flex">{renderStars(review.ratings.ambiance)}</div>
                      <span>{review.ratings.ambiance.toFixed(1)}</span>
                    </div>
                  </div>
          ...
          <div className="bg-white rounded-lg p-6 w-full max-w-4xl max-h-[90vh] overflow-y-auto">
            ...
            <div className="space-y-6">
              ...
              <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div>
                    <Label htmlFor="overall">Puntuación General</Label>
                    <Select value={formData.ratings.overall.toString()} onValueChange={(value) => setFormData({
                      ...formData, 
                      ratings: { ...formData.ratings, overall: parseFloat(value) }
                    })}>
                      <SelectTrigger>
                  ...
                  <div>
                    ...
                    <Select value={formData.ratings.ambiance.toString()} onValueChange={(value) => setFormData({
                      ...formData, 
                      ratings: { ...formData.ratings, ambiance: parseFloat(value) }
                    })}>
                      <SelectTrigger>
                        <SelectValue placeholder="Selecciona puntuación" />
                      </SelectTrigger>
