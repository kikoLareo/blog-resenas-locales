      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <h2 className="text-3xl font-bold mb-4">
            Descubre los mejores locales cada semana
          </h2>
          <p className="text-lg text-muted-foreground mb-8">
            Únete a nuestra comunidad de food lovers y recibe reseñas exclusivas, 
            nuevas aperturas y ofertas especiales directamente en tu bandeja de entrada.
          </p>
          ...
          <p className="text-sm text-muted-foreground mt-4">
            Sin spam. Solo las mejores reseñas. Cancela cuando quieras.
          </p>
          
          <div className="flex items-center justify-center space-x-6 mt-8 text-sm text-muted-foreground">
            <div className="flex items-center space-x-1">
              <CheckCircle className="h-4 w-4 text-green-500" />
              <span>Reseñas exclusivas</span>
            </div>
            <div className="flex items-center space-x-1">
              <CheckCircle className="h-4 w-4 text-green-500" />
